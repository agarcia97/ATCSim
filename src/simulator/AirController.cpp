...
AirController::doWork()
{
  ...
  //Waypoints circuito1
  Position pos1_1(13640.0, 2250.0, 3000.0);
  Position pos1_2(6820.0, 2250.0, 3000.0);
  Position pos1_3(6820.0, 12640.0, 3000.0);
  Position pos1_4(12140.0, 12640.0, 3000.0);
  Position pos1_5(12140.0, 3750.0, 3000.0);
  Position pos1_6(8320.0, 3750.0, 3000.0);
  ...
  Position pos1_15(10640.0, 750.0, 1500.0);

  //Waypoints circuito2
  Position pos2_1(5320.0, 14140.0, 3000.0);
  ...
  Position pos2_15(5320.0, 1500.0, 500.0);

  //Waypoints circuito3
  Position pos3_1(13640.0, -2250.0, 3000.0);
  Position pos3_2(6820.0, -2250.0, 3000.0);
  Position pos3_3(6820.0, -12640.0, 3000.0);
  Position pos3_4(12140.0, -12640.0, 3000.0);
  Position pos3_5(12140.0, -3750.0, 3000.0);
  Position pos3_6(8320.0, -3750.0, 3000.0);
  ...
  Position pos3_15(10640.0, -750.0, 1500.0);

  //Waypoints circuito4
  Position pos4_1(5320.0, -14140.0, 3000.0);
  ...
  Position pos4_15(5320.0, -1500.0, 500.0);


  Route r0, r1, r2, r3, raux, raux2, raux3, raux4, raux5;
  Route c1_1, c1_2, c1_3, c1_4, c1_5, c1_6, c1_7, c1_8, c1_9, c1_10, c1_11, c1_12, c1_13, c1_14, c1_15;
  Route c2_1, c2_2, c2_3, c2_4, c2_5, c2_6, c2_7, c2_8, c2_9, c2_10, c2_11, c2_12, c2_13, c2_14, c2_15;
  Route c3_1, c3_2, c3_3, c3_4, c3_5, c3_6, c3_7, c3_8, c3_9, c3_10, c3_11, c3_12, c3_13, c3_14, c3_15;
  Route c4_1, c4_2, c4_3, c4_4, c4_5, c4_6, c4_7, c4_8, c4_9, c4_10, c4_11, c4_12, c4_13, c4_14, c4_15;
...
//&& (*it)->getPosition().get_x()>=AIRPORT_DISTANCE_MAX*cos(0.25*M_PI) && (*it)->getPosition().get_y()>=0
  ...
  for(it = flights.begin(); it!=flights.end(); ++it){
    if((*it)->getRoute()->empty()){
      ...
      if((*it)->getPosition().get_x()>=AIRPORT_DISTANCE_MAX*cos(0.25*M_PI) && (*it)->getPosition().get_y()>=0 && (*it)->getPosition().get_y()<=AIRPORT_DISTANCE_MAX*sin(0.25*M_PI)){
      ...
      }else if((*it)->getPosition().get_x()>=AIRPORT_DISTANCE_MAX*cos(0.25*M_PI) && (*it)->getPosition().get_y()<0 && (*it)->getPosition().get_y()>=-AIRPORT_DISTANCE_MAX*sin(0.25*M_PI)){
